...
*/
angular.module('urgentresponse.services.DeviceInfo', []).factory('getDeviceInfo', function($q){
   return function (done){
    console.log("on deviceInfo");   
    var deferred = $q.defer();
    var deviceInfo = cordova.require("com.vliesaputra.deviceinformation.DeviceInformation");
